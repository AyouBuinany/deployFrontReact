...
import {postToken} from '../../redux/action/tokenAction'
 ...
 class LoginVendeur extends Component {
constructor(props) {
 ...
 console.log(this.props.postToken);
  this.props.postToken(email, password,'vendeurs')
     .then(res => {
...
export default connect(mapStoreToProps,mapDispatchToProps)(LoginVendeur)
